...
/**
 * GET /api/clubs/[id]
 * Public endpoint for retrieving club details for players.
 * Returns only public fields and ensures the club is visible.
 * For admin access with full details, use /api/admin/clubs/[id]
 */
export async function GET(
  ...
  try {
    ...
    // Return public club details for players
    return NextResponse.json({
      id: club.id,
      name: club.name,
      slug: club.slug,
